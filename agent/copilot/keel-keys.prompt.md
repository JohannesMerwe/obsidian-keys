---
description: Write ticket-style ids (KB-3, KEEL-42) that actually resolve to a card, and mint new ones through board.json's next counter. Never reuse, renumber or invent an id.
mode: agent
---
